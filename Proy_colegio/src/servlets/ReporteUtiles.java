 ...
 */
@WebServlet("/ReporteUtiles")
public class ReporteUtiles extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = 
					getServletContext().getRequestDispatcher("/directora_lista_utiles.jsp");
...
try {
			...
			RequestDispatcher rd = 
					getServletContext().getRequestDispatcher("/directora_lista_utiles2.jsp");
			rd.forward(request, response);
