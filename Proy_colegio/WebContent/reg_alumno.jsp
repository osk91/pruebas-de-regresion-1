...
if( request.getAttribute("vectorgrupo") != null){
	 vectorgrupo = (Vector)request.getAttribute("vectorgrupo");
	 vcodigo= (Vector)request.getAttribute("vcodigo");
}
...
<form id="form1" name="form1" method="post" action="AgregarAlumno">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><fieldset>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="23%" class="class2">Codigo Alumno</td>
                  <td width="77%"><label for="textfield"></label>
                                                            <input type="hidden" name="txt_id" id="textfield" value="<%=vcodigo.get(0) %>" />
                  
                                         <input type="text" name="none" id="textfield" value="<%=vcodigo.get(0) %>" disabled="disabled" /></td>
                </tr>
                ...
                <tr>
                  ...
                  <td><label for="textfield6"></label>
                    <input type="text" name="txt_apoderado" id="textfield6" value="" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><label for="textfield8"></label>
                    <input type="text" name="txt_distrito" id="textfield8" value="" /></td>
                </tr>
              </table>
              <br />
            </fieldset></td>
