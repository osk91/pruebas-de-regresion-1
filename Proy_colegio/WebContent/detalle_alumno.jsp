...
<form id="form1" name="form1" method="post" action="/Proy_colegio/secretaria_reg_alumnos1.jsp">
  <table width="639" border="0" align="center" cellpadding="0" cellspacing="0" background="img/acuarela.jpg">
    ...
    <tr>
      <td colspan="4"><fieldset>
        <p class="class2">Verificar los datos</p>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><fieldset>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="class2">Codigo</td>
                  <td><input type="text" name="" id="textfield" value="<%=alumnolista.get(0).getId() %>" disabled="disabled" />
</td>
                </tr>
                <tr>
                  ...
                  <td width="77%"><label for="textfield"></label>
                    ...
                    <input type="text" name="txt_nombre" id="textfield" value="<%=alumnolista.get(0).getNombre() %>" disabled="disabled" /></td>
                </tr>
                <tr>
                  <td class="class2">Apellidos</td>
                  <td><label for="textfield2"></label>
                    <input type="text" name="txt_apellido" id="textfield2" value="<%=alumnolista.get(0).getApellido() %>" disabled="disabled" /></td>
                </tr>
                <tr>
                  <td class="class2">DNI</td>
                  <td><label for="textfield3"></label>
                    <input type="text" name="txt_dni" id="textfield3" value="<%=alumnolista.get(0).getDni() %>" disabled="disabled"/></td>
                </tr>
                <tr>
                  <td class="class2">Direccion</td>
                  <td><label for="textfield4"></label>
                    <input type="text" name="txt_direccion" id="textfield4" value="<%=alumnolista.get(0).getDireccion() %>"  disabled="disabled"/></td>
                </tr>
                <tr>
                  <td class="class2">Correo</td>
                  <td><label for="textfield5"></label>
                    <input type="text" name="txt_correo" id="textfield5" value="<%=alumnolista.get(0).getCorreo() %>" disabled="disabled" /></td>
                </tr>
                <tr>
                  <td class="class2">Apoderado</td>
                  <td><label for="textfield6"></label>
                    <input type="text" name="txt_apoderado" id="textfield6" value="<%=alumnolista.get(0).getApoderado() %>" disabled="disabled" /></td>
                </tr>
                <tr>
                  <td class="class2">Telefono</td>
                  <td><label for="textfield7"></label>
                    <input type="text" name="txt_telefono" id="textfield7" value="<%=alumnolista.get(0).getTelefono() %>" disabled="disabled" /></td>
                </tr>
                <tr>
                  <td class="class2">Distrito</td>
                  <td><label for="textfield8"></label>
                    <input type="text" name="txt_distrito" id="textfield8" value="<%=alumnolista.get(0).getDistrito() %>" disabled="disabled" /></td>
                </tr>
              </table>
              <br />
            </fieldset></td>
                ...
                <tr>
                  ...
                  <td><label for="select2"></label>
                    <select name="cb_estado" id="select2">
                      ...
                      <option><%=alumnolista.get(i).getEstado() %></option>
                     <%} %> 
                    </select></td>
                </tr>
              </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="93%" align="right"><input type="button" name="button4" id="button4" value="Volver" onclick="window.location='/Proy_colegio/secretaria_reg_alumnos1.jsp'" /></td>
            <td width="7%" align="right"><input type="submit" name="button2" id="button2" value="Listo" /></td>
          </tr>
        </table>
        <p class="class2"><br />
        </p>
