...
<form id="form1" name="form1" method="post" action="">
  <table width="639" border="0" align="center" cellpadding="0" cellspacing="0" background="img/acuarela.jpg">
    <tr>
      <td width="598" valign="top" class="class1"><p><img src="img/logo.jpg" width="71" height="70" />BIENVENIDA SECRETARIA</p></td>
    ...
    <tr>
      <td colspan="2" align="right">Todos los derechos reservados</td>
    </tr>
  </table>
</form>
</body>
