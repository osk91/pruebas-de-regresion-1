...
<form id="form1" name="form1" method="post" action="ReporteUtiles">
  ...
  <table width="639" border="0" align="center" cellpadding="0" cellspacing="0" background="img/acuarela.jpg">
    ...
    <tr>
      <td colspan="2"><fieldset>
        <p class="class2">Lista de Utiles por Grupo</p>
          ...
          <tr>
            <td colspan="3"><table width="100%" border="1" cellspacing="0" cellpadding="0">
              <tr class="class2">
                ...
                <th rowspan="2" align="center" nowrap="nowrap" scope="col">&nbsp;</th>
                </tr>
