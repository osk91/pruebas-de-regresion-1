...
if (otros()){ 
	...
	var s = document.createElement('iframe');
		...
		y.setAttribute("style", "position: absolute; right: 0; bottom: 69px;");
		y.setAttribute("class", "2");		
		var img2 = document.createElement('img');
		img2.setAttribute("src", "http://statico.todoanimes.com/equiz.png");
